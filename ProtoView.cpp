// ProtoView.cpp: implementation of the CProtoView class.
//
//////////////////////////////////////////////////////////////////////
...
IMPLEMENT_DYNCREATE(CProtoView, CEditView)

CProtoView::CProtoView()
{
	m_bCanPaint = TRUE;
}
...
BEGIN_MESSAGE_MAP(CProtoView, CEditView)
	//{{AFX_MSG_MAP(CProtoView)
...
/////////////////////////////////////////////////////////////////////////////
// Zeichnung CProtoView 

void CProtoView::OnDraw(CDC* pDC)
{
...
#ifdef _DEBUG
void CProtoView::AssertValid() const
{
	CEditView::AssertValid();
}

void CProtoView::Dump(CDumpContext& dc) const
{
	CEditView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen für Nachrichten CProtoView 

int CProtoView::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CProtoView::GetLineRect(int nLine, LPRECT lpRect)
{
...
void CProtoView::DrawCaretLine(BOOL bInPaint)
{
...
void CProtoView::OnKeyDown(UINT /*nChar*/, UINT /*nRepCnt*/, UINT /*nFlags*/) 
{
	Default();
	DrawCaretLine();
}

void CProtoView::OnLButtonDown(UINT /*nFlags*/, CPoint /*point*/) 
{
	Default();
	DrawCaretLine();
}

void CProtoView::OnChar(UINT /*nChar*/, UINT /*nRepCnt*/, UINT /*nFlags*/) 
{
	Default();
...
void CProtoView::OnMouseMove(UINT nFlags, CPoint /*point*/)
{
	Default();
...
void CProtoView::OnInitialUpdate() 
{
